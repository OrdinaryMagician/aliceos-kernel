...
signature:
	...
	; UTF-8 string, should be lokated 4096 bytes into the file
	; an easy way to read it is to use strings with 8-bit char size (-e S)
	db 0x41,0x4C,0x49,0x43,0x45,0x4F,0x53,0xE3
	db 0x81,0xA7,0xE3,0x82,0x8C,0x41,0x4F,0x53
	db 0x4B,0x45,0x52,0x4E,0x45,0x4C,0x0A,0x00
	...
	db 0x90,0x86,0xe6,0xb2,0x99,0x0A,0x00,0x00
